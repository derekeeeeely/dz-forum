...
export type deliveredTopicListQueryVariables = {
    readonly count?: number | null;
    readonly cursor?: any | null;
    readonly condition?: TopicCondition | null;
};
export type deliveredTopicListQueryResponse = {
    readonly " $fragmentRefs": delivered_data$ref;
};
export type deliveredTopicListQuery = {
    readonly response: deliveredTopicListQueryResponse;
    readonly variables: deliveredTopicListQueryVariables;
};
...
return {
  ...
  "params": {
    "operationKind": "query",
    "name": "deliveredTopicListQuery",
    "id": "e7a00a605a6be1ca7c9615e2a0119aa5",
    "text": null,
    "metadata": {}
  }
};
})();
(node as any).hash = '9af058e8ddd37fe1e74abb54fcd9a331';
export default node;
