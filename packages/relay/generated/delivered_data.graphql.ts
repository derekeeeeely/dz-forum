...
declare const _delivered_data$ref: unique symbol;
export type delivered_data$ref = typeof _delivered_data$ref;
export type delivered_data = {
    readonly deliveredTopics: {
    ...
    readonly " $refType": delivered_data$ref;
};
  ...
  "selections": [
    {
      ...
      "name": "__delivered_deliveredTopics_connection",
      "storageKey": null,
      "args": [
        {
          "kind": "Variable",
...
(node as any).hash = '4a38b605a881f4b910ad4fbfb5c2417f';
export default node;
