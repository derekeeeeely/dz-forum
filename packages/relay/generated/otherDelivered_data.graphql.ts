...
declare const _otherDelivered_data$ref: unique symbol;
export type otherDelivered_data$ref = typeof _otherDelivered_data$ref;
export type otherDelivered_data = {
    readonly otherDeliveredTopics: {
    ...
    readonly " $refType": otherDelivered_data$ref;
};
  ...
  "selections": [
    {
      ...
      "name": "__otherDelivered_otherDeliveredTopics_connection",
      "storageKey": null,
      "args": [
        {
          "kind": "Variable",
...
(node as any).hash = 'd4c8e14d9f53652e2546496a539d26df';
export default node;
